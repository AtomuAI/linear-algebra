...
pub struct Quaternion2x2<T>( Matrix2x2<Complex<T>> )
where
    T: 'static + Default + Copy + Debug;

impl<T> Quaternion2x2<T>
where
...
impl<T> Deref for Quaternion2x2<T>
where
...
impl<T> Add for Quaternion2x2<T>
where
...
impl<T> Sub for Quaternion2x2<T>
where
...
impl<T> Mul for Quaternion2x2<T>
where
...
impl<T> Div for Quaternion2x2<T>
where
...
impl<T> Add<T> for Quaternion2x2<T>
where
    T: Default + Copy + Debug + Num + Add<Output = T>,
    Self: Clone
{
...
impl<T> Sub<T> for Quaternion2x2<T>
where
    T: Default + Copy + Debug + Num + Sub<Output = T>,
    Self: Clone
{
...
impl<T> Mul<T> for Quaternion2x2<T>
where
    T: Default + Copy + Debug + Num + Mul<Output = T>,
    Self: Clone
{
...
impl<T> Div<T> for Quaternion2x2<T>
where
    T: Default + Copy + Debug + Num + Div<Output = T>,
    Self: Clone
{
...
impl<T> AddAssign for Quaternion2x2<T>
where
...
impl<T> SubAssign for Quaternion2x2<T>
where
...
impl<T> MulAssign for Quaternion2x2<T>
where
...
impl<T> DivAssign for Quaternion2x2<T>
where
...
impl<T> AddAssign<T> for Quaternion2x2<T>
where
    T: Default + Copy + Debug + Num + NumAssign + AddAssign,
{
...
impl<T> SubAssign<T> for Quaternion2x2<T>
where
    T: Default + Copy + Debug + Num + NumAssign + SubAssign,
{
...
impl<T> MulAssign<T> for Quaternion2x2<T>
where
    T: Default + Copy + Debug + Num + NumAssign + MulAssign,
{
...
impl<T> DivAssign<T> for Quaternion2x2<T>
where
    T: Default + Copy + Debug + Num + NumAssign + DivAssign,
{
...
impl<T> Index<[usize; 2]> for Quaternion2x2<T>
where
    T: Default + Copy + Debug,
{
...
impl<T> IndexMut<[usize; 2]> for Quaternion2x2<T>
where
    T: Default + Copy + Debug,
{
...
// Flat Indexing
impl<T> Index<usize> for Quaternion2x2<T>
where
    T: Default + Copy + Debug,
{
    type Output = Complex<T>;
...
impl<T> IndexMut<usize> for Quaternion2x2<T>
where
    T: Default + Copy + Debug,
{
...
mod tests {
    ...
    #[test]
    fn new_quat_test() {
        let quat = Quaternion2x2::new( 1.0, 2.0, 3.0, 4.0 );
    ...
    #[test]
    fn from_euler_test() {
        let quat = Quaternion2x2::from_euler( 0.0, 0.0, 0.0 );
