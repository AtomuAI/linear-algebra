...
pub struct RotXYZ<T>( Matrix3x3<T> )
where
...
impl<T> AddAssign<T> for RotXYZ<T>
where
    T: Default + Copy + Debug + Num + NumAssign + AddAssign,
{
...
impl<T> SubAssign<T> for RotXYZ<T>
where
    T: Default + Copy + Debug + Num + NumAssign + SubAssign,
{
...
impl<T> MulAssign<T> for RotXYZ<T>
where
    T: Default + Copy + Debug + Num + NumAssign + MulAssign,
{
...
impl<T> DivAssign<T> for RotXYZ<T>
where
    T: Default + Copy + Debug + Num + NumAssign + DivAssign,
{
...
impl<T> Index<[usize; 2]> for RotXYZ<T>
where
    T: Default + Copy + Debug,
{
    type Output = T;
...
impl<T> IndexMut<[usize; 2]> for RotXYZ<T>
where
    T: Default + Copy + Debug,
{
...
// Flat Indexing
impl<T> Index<usize> for RotXYZ<T>
where
    T: Default + Copy + Debug,
{
    type Output = T;
...
impl<T> IndexMut<usize> for RotXYZ<T>
where
    T: Default + Copy + Debug,
{
